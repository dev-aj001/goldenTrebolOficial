...
public class ButtonMenu extends JButton {
    ...
    public void setIconName(String iconName) {
        ...
        setIcon(new ImageIcon(getClass().getResource("/iconos/" + iconName + ".png")));
    }
    ...
    public void paint(Graphics grphcs) {
        if (isSelected()) {
            ...
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setPaint(new GradientPaint(0, 0, new Color(255,195,0), 0, height * 2, new Color(255, 242, 85)));
    ...
    public void setSelected(boolean bln) {
        ...
        if (bln) {
            setIcon(new ImageIcon(getClass().getResource("/iconos/" + iconName + "s.png")));
