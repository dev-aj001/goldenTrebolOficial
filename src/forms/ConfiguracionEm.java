 ...
 * @author jairi
 */
public class ConfiguracionEm extends javax.swing.JPanel {

    private static ConfiguracionEm instance;
    
    public ConfiguracionEm() {
        initComponents();
        setOpaque(false);
    }

    public static ConfiguracionEm getInstance(){
        if(instance == null){
            instance = new ConfiguracionEm();
        }
        return instance;
    }
