...
public class Credenciales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Esta acción requiere la confirmación de sus credenciales de administrador.");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 400, 20));

        jLabel2.setText("Contraseña:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 70, -1));
        jPanel1.add(txtPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 210, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Credenciales(user).setVisible(true);
            }
        });
    }
