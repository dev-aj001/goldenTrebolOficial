...
import forms.AlmacenEm;
import forms.Caja;
import forms.Configuracion;
import forms.ConfiguracionEm;
...
public class MainEm extends javax.swing.JFrame {

    private int xMouse;
    private int yMouse;
    private static String user;
    
    public MainEm(String usern) {
        initComponents();
        user = usern;
        menuEm1.setLbluserName(usern);
    ...
    private void initComponents() {
        ...
        menuEm1 = new componentes.MenuEm();
        ...
        panelBackground1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBackground1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(menuEm1, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelBackground1Layout.setVerticalGroup(
            ...
            .addGroup(panelBackground1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(menuEm1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(panelBackground1Layout.createSequentialGroup()
                        .addComponent(header1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(11, 11, 11)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainEm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainEm(user).setVisible(true);
            }
        });
    }
    ...
    private componentes.MenuEm menuEm1;
